...
define("SubtitlesPlugin", [], function () {
  ...
  SubtitlesPlugin.prototype = {
    ...
    getTTMetadata: function (ttNode) {
      ...
      ttNodeObject = _.compact(
        _.map(
          ttNode.attributes,
          function (attr) {
            return this.parseTTAtributtes(
              attr.nodeName,
              attr.nodeValue,
              ttNode
            );
        ...
        case "ebutts:multiRowAlign":
          return {
            "noop-multiRowAlign": function (el) {
              _.each(
                el.getElementsByClassName("multiRowAlign"),
                function (node) {
        ...
        case "ebutts:linePadding":
          return {
            "noop-linePadding": function (el) {
              ...
              _.each(
                el.getElementsByClassName("subtitle-line"),
                function (subtitleLineEl) {
          ...
          return {
            "noop-origin": function (el) {
              var ttsPositionArray = nodeValue.split(" "),
                ...
                height;
              if (
                that.personalizationEnabled &&
                that.getSubtPositionPersonalized() === "top"
              ) {
                height = parseFloat(
                  sty.getAttribute("tts:extent").split(" ")[1].split("%")[0]
                );
        ...
        case "tts:padding":
          return {
            "noop-padding": function (el) {
              _.each(
                el.getElementsByClassName("regionPadding"),
                function (node) {
        ...
        case "tts:displayAlign":
          return {
            "noop-displayAlign": function (el) {
              ...
              _.each(
                el.getElementsByClassName("displayAlign"),
                function (node) {
        ...
        function (child) {
          switch (child.nodeName) {
            ...
            case "span":
              ...
              el = this.applyTTMLStyleIdToHTMLElement(
                el,
      ...
      _.each(
        ...
        function (entry) {
          addedCuepoint = this.cuepoints.addCuepoint({
            ...
            negativemargin:
              GLOBALCONFIGURATION.SUBTITLES.BEGINCUEPOINTSMARGIN.NEGATIVE,
            positivemargin:
              GLOBALCONFIGURATION.SUBTITLES.BEGINCUEPOINTSMARGIN.POSITIVE,
          });
          ...
          addedCuepoint = this.cuepoints.addCuepoint({
            ...
            negativemargin:
              GLOBALCONFIGURATION.SUBTITLES.ENDCUEPOINTSMARGIN.NEGATIVE,
            positivemargin:
              GLOBALCONFIGURATION.SUBTITLES.ENDCUEPOINTSMARGIN.POSITIVE,
          });
          this.addedCuepoints.push(addedCuepoint);
        },
        this
    ...
    convertCtoPx: function (value, direction) {
      ...
      if (direction === "x") {
        cellSize =
          this.el.offsetWidth / this.ttNodeConfig.cellResolution.columns;
      } else {
    ...
    getFontSizePersonalizedValue: function () {
      return this.personalizationFontSizeValues[
        this.personalizationFontSizeIndex
      ];
    },
  };
